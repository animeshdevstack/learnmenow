// Script to drop and recreate Phone index with proper sparse configuration
...
async function dropAndRecreatePhoneIndex() {
  try {
    console.log('Starting Phone index recreation...');
    
    // Get the database connection
    const db = mongoose.connection.db;
    
    // Drop the existing Phone_1 index
    try {
    ...
    // Wait a moment for the index to be fully dropped
