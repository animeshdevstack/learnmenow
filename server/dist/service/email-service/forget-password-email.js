...
const sendForgetPasswordEmail = (name, to, resetLink) => __awaiter(void 0, void 0, void 0, function* () {
    try {
          ...
          <div style="max-width: 530px; margin: auto; background: #fff; border-radius: 16px; box-shadow: 0 4px 22px rgba(51,71,120,0.12);">
            ...
            <div style="padding: 34px 32px 26px;">
              ...
              <p style="font-size: 13px; color: #b0b9d1; margin-top: 30px;font-style:italic;">
                Need more help? Contact support at <a href="mailto:${configuration_1.default.ADMIN_GMAIL_ACCOUNT}" style="color: #4568dc; text-decoration: underline;">${configuration_1.default.ADMIN_GMAIL_ACCOUNT}</a>.<br />
